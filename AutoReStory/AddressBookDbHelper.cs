  ...
  public class AddressBookDbHelper: SQLiteOpenHelper
    {
        ...
        public override void OnCreate(SQLiteDatabase db)
        {
            ...
            db.ExecSQL("Insert into AddressBook(FullName,Mobile,Email,Details)VALUES('Shiva Shankhar Prasad Shah','9841536000','sdsd.pyakurel@gmail.com','Hello every one this is test message')");
